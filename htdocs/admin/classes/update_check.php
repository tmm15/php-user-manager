  ...
  <body>
    ...
    <?php if( !empty($errors['user_name']) || 
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control <?php if(!empty($errors['user_name'])) echo 'boder-danger text-danger';?>" id="exampleInputName" name="user_name" aria-describedby="emailHelp" value="<?php echo $user_name; ?>">
        </div>
    <div class="mb-3">
...
<?php } else { ?>
    <from method="POST" action="./update_comp.php">
    <div class="mb-3">
        <label for="exampleInputName" class="form-label">User Name</label>
